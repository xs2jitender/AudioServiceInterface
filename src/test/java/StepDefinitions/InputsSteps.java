...
public class InputsSteps {
    ...
    InputsStepsPage addinputs = new InputsStepsPage();
    ...
    public void i_should_be_seeing_the_sources_link_on_the_main_panel_to_add_inputs() {
        addinputs.addInput();
    }

    @Given("^I click on the main panel of the dashboard page$")
    public void i_click_on_the_main_panel_of_the_dashboard_page() {
    }

    @When("^I click on new source tab$")
    public void i_click_on_new_source_tab() {
        addinputs.addInput();
    }
